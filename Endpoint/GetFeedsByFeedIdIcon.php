...
class GetFeedsByFeedIdIcon extends \Korvium\Plugin\Miniflux\Runtime\Client\BaseEndpoint implements \Korvium\Plugin\Miniflux\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{feedId}'], [$this->feedId], '/feeds/{feedId}/icon');
    }
